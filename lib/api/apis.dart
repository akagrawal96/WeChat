...
static  DatabaseReference usersRef = FirebaseDatabase.instance.ref().child('users');
  ...
  await  FirebaseDatabase.instance.ref().child('users').child(user.uid).set(chatUser.toJson());
